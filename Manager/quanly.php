    ...
    <header class="navbar navbar-inverse navbar-fixed-top" role="banner">
        ...
        <ul class="nav navbar-nav pull-right toolbar">
            <li class="dropdown">
                ...
                <input type="hidden" id="usId" name="custId" value=".$id.">
                        <?php
                        echo "" . $name;
                        ?>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-midnightblue">
                        <div class="panel-heading">
                            <h4>Quản Lý Tài Khoản Đăng Ký</h4>
                        </div>
                                ...
                                <div class="container">
                                    <div id="List">
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tr>
                                                <td><input type="text" name="" id="nameNew" style="width: 100%"></td>
                                                <td><input type="email" name="" id="emailNew" style="width: 100%"></td>
                                                <td><input type="password" name="" id="mkNew" style="width: 100%"></td>
                                                <td><select name="" id="cvNew" style="width: 100%">
                                        ...
                                        <div align="center">
                                            ...
                                            <button type="button" name="cancel" id="cancel" class="btn btn-info">Hủy</button>
                                        </div>
                                        <br>
                                    </div>
                                </div>
